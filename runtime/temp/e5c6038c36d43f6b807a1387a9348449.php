<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"C:\wamp64\www\public/../application/admin\view\auth\adminrule.html";i:1558175186;s:53:"C:\wamp64\www\application\admin\view\common\head.html";i:1654620072;s:53:"C:\wamp64\www\application\admin\view\common\foot.html";i:1558175186;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <blockquote class="layui-elem-quote layui-elem-quote-blue">
                <button  tipsmsg="添加" class="layui-btn layui-btns layui-btn-blue onmousemovebtns" onclick="x_admin_show('添加权限','<?php echo url('ruleadd'); ?>','610px','610px','95%','95%')"><i class="layui-icon"></i>添加</button>
...
<script type="text/html" id="action">
    <a tipsmsg="添加子菜单" class="layuimsg" onclick="x_admin_show('添加子菜单','<?php echo url('ruleadd'); ?>?pid={{d.id}}','610px','610px','95%','95%')">
        <button class="layui-btn layui-btns layui-btn-blue layui-btn-xs">
            <i class="layui-icon"></i>
        </button>
    </a>
    <a tipsmsg="编辑权限" class="layuimsg" onclick="x_admin_show('编辑权限','<?php echo url('ruleedit'); ?>?id={{d.id}}','610px','610px','95%','95%')">
