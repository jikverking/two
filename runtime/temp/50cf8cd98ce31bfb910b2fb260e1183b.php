<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"C:\wamp64\www\public/../application/admin\view\user\useredit.html";i:1558175186;s:55:"C:\wamp64\www\application\admin\view\common\header.html";i:1558175186;s:55:"C:\wamp64\www\application\admin\view\common\footer.html";i:1558175186;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="layui-row">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-4">
                            <input type="text" name="username" autocomplete="off" placeholder="请输入用户名" class="layui-input" value="<?php echo $info['username']; ?>">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-4">
                            <input type="text" name="phone" autocomplete="off" placeholder="请输入手机号" class="layui-input" value="<?php echo $info['phone']; ?>">
                        </div>
                    </div>
                    <?php if($info['id'] != 1): ?>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-4">
                            <input type="text" name="endtime" autocomplete="off"  class="layui-input" id="endtime" value="<?php echo date('Y-m-d',$info['endtime']); ?>">
                        </div>
                    </div>
                    <?php endif; ?>
                    <div class="layui-form-item">
