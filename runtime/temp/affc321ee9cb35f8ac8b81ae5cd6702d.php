<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"C:\wamp64\www\public/../application/admin\view\vip\vipadd.html";i:1654861003;s:55:"C:\wamp64\www\application\admin\view\common\header.html";i:1558175186;s:55:"C:\wamp64\www\application\admin\view\common\footer.html";i:1558175186;}*/ ?>
                ...
                <div class="layui-row">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-4">
                            <input type="text" id="tel" name="tel" autocomplete="off" placeholder="手机号码" class="layui-input">
                        </div>
                    </div>
                        <label class="layui-form-label">充值金额</label>
                        <div class="layui-input-4">
                            <input type="text" name="money" id="money" autocomplete="off" placeholder="请输入手机号" class="layui-input">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-4">
                            <input type="text" id="discount" name="discount" autocomplete="off" placeholder="享受折扣" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-4">
                            <input type="text" id="mima" name="mima" autocomplete="off" placeholder="会员密码" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <div class="layui-input-block">
                            <button type="submit" class="layui-btn layui-btns layui-btn-blue" lay-submit="" lay-filter="vipadd">11添加会员</button>
...
<script type="text/javascript">
    ...
    layui.use(['form','layer','laydate'], function(){
        ...
        //监听提交
        form.on('submit(vipadd)', function(data){
